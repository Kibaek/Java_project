...
public class list_backup extends GenericServlet {
  ...
  public void service(ServletRequest request, ServletResponse response)
    ...
    out.println("<body>");
    	...
    	out.println("				<button type='button' class='btn btn-primary btn-xs' data-toggle='modal' data-target='" + product.getDno() + "'>자세히보기</button>");
    	out.println("			</div>");
    	out.println("		</div>");
